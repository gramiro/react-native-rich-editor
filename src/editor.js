...
<script>
    ...
    var _ = (function (exports) {
        ...
        var Actions = {
            ...
            heading1: { state: function() { return queryCommandValue(formatBlock) === 'h1'; }, result: function() { return queryCommandValue(formatBlock) === 'h1' ? exec(formatBlock, 'div') : exec(formatBlock, '<h1>'); }},
            heading2: { state: function() { return queryCommandValue(formatBlock) === 'h2'; }, result: function() { return queryCommandValue(formatBlock) === 'h2' ? exec(formatBlock, 'div') : exec(formatBlock, '<h2>'); }},
            heading3: { state: function() { return queryCommandValue(formatBlock) === 'h3'; }, result: function() { return queryCommandValue(formatBlock) === 'h3' ? exec(formatBlock, 'div') : exec(formatBlock, '<h3>'); }},
            heading4: { state: function() { return queryCommandValue(formatBlock) === 'h4'; }, result: function() { return queryCommandValue(formatBlock) === 'h4' ? exec(formatBlock, 'div') : exec(formatBlock, '<h4>'); }},
            heading5: { state: function() { return queryCommandValue(formatBlock) === 'h5'; }, result: function() { return queryCommandValue(formatBlock) === 'h5' ? exec(formatBlock, 'div') : exec(formatBlock, '<h5>'); }},
            heading6: { state: function() { return queryCommandValue(formatBlock) === 'h6'; }, result: function() { return queryCommandValue(formatBlock) === 'h6' ? exec(formatBlock, 'div') : exec(formatBlock, '<h6>'); }},
            paragraph: { state: function() { return queryCommandValue(formatBlock) === 'p'; }, result: function() { return queryCommandValue(formatBlock) === 'p' ? exec(formatBlock, 'div') : exec(formatBlock, '<p>'); }},
